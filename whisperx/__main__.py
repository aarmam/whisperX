...
def cli():
    ...
    parser.add_argument("--align_batch_size", type=int, default=16, help="Batch size for alignment stage (default: 16). Higher values improve GPU utilization but use more memory.")
